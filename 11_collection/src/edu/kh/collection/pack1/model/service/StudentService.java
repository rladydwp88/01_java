...
// import edu.kh.collection.pack1.model.Student;
...
public class StudentService {
	...
	public void ex() { // List 테스트용 예제
		...
		testList.add("문자열");
		testList.add(new Student("홍길동", 24, "서울시 중구", 'M', 90));
		testList.add(sc);
	...
	*/
	 ...
	 * 
	 * @author 김용제(rladydwp88@gmail.com)
	 */
	...
	public String addStudent() {
		...
		// UncheckedIOException : 강제처리 x, 예외 발생하면 자동으로
		// 상위 호출 메서드로 예외가 전파됨
	 ...
	 * 3. 학생 정보 수정 메서드
	 * 
	 * -학생 정보가 studentList에 하나라도 있는 검사
	...
	public String updateStudent() {
		...
		// 1) 학생정보가 studentList에 하나라도 있는지 검사
		if(studentList.isEmpty()) {
			...
			System.out.println(index + "번째에 저장 된 학생 정보");
			...
			// index번째에 있던 기존 학생 정보가 반환 되고, 그 객체를 temp에 저장
	...
	public String removeStudent() {
		...
		// remove() 동작시 뒤쪽 요소를 한칸씩 자동으로 당겨온다.
		
		System.out.println("제거 할 인덱스 번호 : ");
		int index = sc.nextInt();
