...
public class SetService {
	...
	public void method2() {
		...
		// 1. 빈 List를 객체 생성
		// addAll() 메서드나 생성자 등을 이용해서 Set의 요소들을 List에 추가
		// 3. 변환 완료
	...
	public void method3() {
		...
		System.out.println("p34 : " + p4.hashCode());
	...
	public void method4() {
		...
		// 난수 생성
		// 1) Math.random()
		// 2) Random.nexInt(10) : 임의의 정수 값 생성
		//    0~9 범위 내 정수 반환
	 ...
	 * 
	 * 금액을 입력받아 (천원 단위)
	 * 1000원 당 1회씩 번호를 생성해서 Listdp wjwkdgks gn
	 * 생성 종료시 한번에 출력
	 * 
	 * <pre>
	 * 금액 입력 : 3000
