...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		// new in[3] : heap 영역에 int 형 변수 3칸짜리 int[] 을 생성(할당)
		...
		// [10, 5, 100] 실제로 arr 배열이 가진 모든 요소의 값을 알고 싶을때
		// Arrays.toString(arr);
	...
	public void ex3() {
		...
		// 배열의 각 요소에 대입되어 있는 갑을 사용(합계)하는 용도의 반복문
		for(int i = 0; i < height.length; i++) {
	...
	public void ex4() {
		...
		*/
		...
		// 배열 선언 및 할당
		// 할당할 배열의 크기는 입력 받은 인원수 크기만큼(input)
	...
	public void ex6() {
		...
		// flag 상태를 검사
		// flag가 false 라면 일치하는 값을 찾지 못했다 라는 의미
	...
	public void ex9() {
		...
		// 2. 문자 하나를 입력받아 일치하는 문자가 char 배열에 몇개 존재하는지 왁인
		...
		String input = sc.nextLine(); // hello world [h, e, l, l,  w, o, r, l, d]
		...
		// sc.next() -> String형
		// Strring.chatAt(0) -> String의 0번째 인덱스 문자 하나를 추출해서 char 형태로 반환
		// "h" -> 'h'
