...
public class ObjectService {
	 ...
	 * 직렬화
	 * - 객체를 직렬(직선)형태로 변환
	 *   직렬화한 객체의 상태(필드값)을 바이트 스트림으로 변환하는 과정
	...
	public void objectInput() {
		...
		try {
			...
			// ois.readObject(); : 직렬화된 객체를 읽어와 역직렬화
			// 					+ Member 객체로 변경(다운캐스팅)
