...
public class ByteService {
	...
	public void fileByteOutput() {
		// FileOutputStream 참조 변수 선언 (OutputStream 상속 받은 자식 클래스)
		...
		try {
			...
			for(int i=0; i < content.length(); i++) {
				...
				fos.write(ch); //1byte 출력 스트림이 연결 된 파일에 ch 쓰기
			}
			*/
